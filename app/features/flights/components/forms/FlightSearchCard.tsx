            ...
            <div className="flex items-center justify-between">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">
                  {(currentSearch as current_search).origin_code}
                </div>
                <div className="text-xs text-gray-500">
                  {formatFlightDate((currentSearch as current_search).origin_date)}
                </div>
                {/* Amenities */}
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">
                  {(currentSearch as current_search).destination_code}
                </div>
                <div className="text-xs text-gray-500">
                  {formatFlightDate((currentSearch as current_search).destination_date)}
                </div>
                {/* Amenities */}
                <div className="flex items-center space-x-3 mt-4">
                  {["wifi", "meals", "entertainment"].map((amenity, index) => (
